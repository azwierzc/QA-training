...
def postprocess_qa_predictions(
    ...
    example_id_to_index = {k: i for i, k in enumerate(examples["example_id"])}
    ...
    for example_index, example in enumerate(tqdm(examples)):
        ...
        if not version_2_with_negative:
            ...
            scores_diff_json[example["example_id"]] = float(score_diff)  # To be JSON-serializable.
        ...
        all_nbest_json[example["example_id"]] = [
